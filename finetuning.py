...
# .....................................................................................................................
TRAIN_DATASET_PATH = '/home/joshua_zhu/PCNSL/T1/T1images'
# .....................................................................................................................
...
epochs = 1000
learning_rate = 0.0001 #LR was naive pretrained model was 0.001 (1/10 of this)
...
# .....................................................................................................................
# Finetune Model Definitions
# .....................................................................................................................
wandb.init(
    project="PCNSL-finetuning",
...
#Pretrained model
glioma_model = UNet(num_classes=1)
glioma_model_path = '/home/joshua_zhu/PCNSL/T1glioma/T1gliomaimages/best_model.pth'
glioma_model = load_model_weights(glioma_model, glioma_model_path)

model = PretrainedUNet(num_classes=1, freeze_encoder=True) # Remember to set freeze encode to True/False

# For additional epochs
# model.load_state_dict(torch.load('/home/joshua_zhu/PCNSL/T1/T1images/finetunedmodel2.pth'))
...
optimizer = torch.optim.Adam(model.parameters(), lr=0.0001)  # Adjust as necessary
...
train_and_val_directories.remove(TRAIN_DATASET_PATH + '/masks')
train_and_val_directories.remove(TRAIN_DATASET_PATH + '/predictions')
...
# Saving test IDs for later evaluation
test_ids_path_finetune = os.path.join(TRAIN_DATASET_PATH, "test_ids_finetune.txt")
with open(test_ids_path_finetune, 'w') as file:
    for id in test_ids:
        file.write("%s\n" % id)
...
def load_dataset(ids, path, augment=True):
    ...
    for id in ids:
        if id.startswith("YG_"):
            t1 = nib.load(f"{path}/{id}/img_preprocessed.nii.gz").get_fdata()
            seg = nib.load(f"{path}/{id}/seg_preprocessed.nii.gz").get_fdata()

            num_slices = seg.shape[2]
            step = 1 if num_slices < 20 else 2  # Every slice if fewer than 20, otherwise every other slice
            ...
            for s in range(0, num_slices, step):
                ...
                # Convert mask to float32 for resizing
                mask_float = mask.astype(np.float32)
                mask_resized = cv2.resize(mask_float, (256, 256), interpolation=cv2.INTER_NEAREST)
                # Convert resized mask back to bool
                mask_resized = mask_resized > 0.5

                if data_transform:
                    transformed_data = data_transform((image_resized, mask_resized))
                    image_resized, mask_resized = transformed_data
...
for epoch in tqdm(range(epochs)):
    ...
    for batch, (X, y) in enumerate(train_dataloader):
        ...
        loss = loss_1 + loss_2
        train_loss += loss.item()  # add up the loss per epoch
    ...
    scheduler.step(test_loss)  # Update the learning rate based on the validation loss
    ...
    if test_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), '/home/joshua_zhu/PCNSL/T1/T1images/best_finetunedmodel.pth')
